          ...
          <>
            ...
            {showInfo && (
              <div className="bg-gray-700 mt-4 p-4 rounded-lg text-sm text-gray-300">
                ...
                <p>Доминация — это доля актива в общей в общей стоимости всего крипторынка. Показывает, сколько она "весит" на рынке.</p>
                <p>Например, если рынок стоит $100, а Биткоин — $60, его доминация = 60%.</p>
